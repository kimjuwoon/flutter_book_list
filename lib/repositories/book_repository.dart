...
class BookRepository {
  final List<Book> _dummyBooks = [
    ...
    Book(
      ...
      description:
          'N잡러, 부캐의 등장으로 "콘텐츠 제작"은 이제 우리 모두의 이야기가 되었습니다. 더불어 기획자, 마케터, PM 등 더오르는 직업의 기본 소양은 바로 "콘텐츠 제작" 입니다. 디자인이랑 친하지도 않고, 포토샵은 해본 적도 없는 여러분이 지금 당장 콘텐츠를 만들기 위해서 필요한 것은, 바로 <바.바.복>입니다. ',
      image:
          'https://img1.daumcdn.net/thumb/R1280x0/?scode=mtistory2&fname=https%3A%2F%2Fblog.kakaocdn.net%2Fdn%2Flzlyb%2Fbtq8nD5gYAf%2FiuHnWoFZPoBM35Y89aQZb0%2Fimg.png',
    ),
    Book(
